...
export class AutomationEmailController {
  ...
  async create(@Body() dto: CreateAutomationEmailDto) {
    const input: CreateAutomationEmailInput = {
      ...
      autm_departament: dto.autm_departament ? dto.autm_departament.toUpperCase() : null,
      autm_city: dto.autm_city ? dto.autm_city.toUpperCase() : null,
      autm_locality: dto.autm_locality ? dto.autm_locality.toUpperCase() : null,
      autm_court_name: dto.autm_court_name ? dto.autm_court_name.toUpperCase() : null,
      autm_specialty: dto.autm_specialty ? dto.autm_specialty.toUpperCase() : null,
      autm_office_name: dto.autm_office_name ? dto.autm_office_name.toUpperCase() : null,
      autm_year: dto.autm_year ?? null,
      autm_process_class: dto.autm_process_class ? dto.autm_process_class.toUpperCase() : null,
      autm_process_code: dto.autm_process_code ? (dto.autm_process_code.replace(/\D/g, '') || null) : null,
      autm_resource_process: dto.autm_resource_process ?? null,
      autm_subject_demanding: dto.autm_subject_demanding ? dto.autm_subject_demanding.toUpperCase() : null,
      autm_artificial_person: dto.autm_artificial_person ? dto.autm_artificial_person.toUpperCase() : null,
      autm_document_type_1: dto.autm_document_type_1 ? dto.autm_document_type_1.toUpperCase() : null,
      ...
      autm_subject_defendant: dto.autm_subject_defendant ? dto.autm_subject_defendant.toUpperCase() : null,
      autm_natural_person: dto.autm_natural_person ? dto.autm_natural_person.toUpperCase() : null,
      autm_document_type_2: dto.autm_document_type_2 ? dto.autm_document_type_2.toUpperCase() : null,
  ...
  @ApiQuery({ name: 'autm_court_name', required: false, type: String, description: 'Filtrar por nombre del juzgado (búsqueda parcial).' })
  @ApiQuery({ name: 'autm_specialty', required: false, type: String, description: 'Filtrar por especialidad (búsqueda parcial).' })
  @ApiQuery({ name: 'autm_office_name', required: false, type: String, description: 'Filtrar por número de despacho (búsqueda parcial).' })
  @ApiQuery({ name: 'autm_year', required: false, type: String, description: 'Filtrar por año del proceso (exacto).' })
  @ApiQuery({ name: 'autm_process_class', required: false, type: String, description: 'Filtrar por clase de proceso (búsqueda parcial).' })
  @ApiQuery({ name: 'autm_process_code', required: false, type: String, description: 'Filtrar por código de proceso (búsqueda parcial).' })
  ...
  async findAll(
    ...
    @Query('autm_court_name') autm_court_name?: string,
    @Query('autm_specialty') autm_specialty?: string,
    @Query('autm_office_name') autm_office_name?: string,
    @Query('autm_year') autm_year?: string,
    @Query('autm_process_class') autm_process_class?: string,
    @Query('autm_process_code') autm_process_code?: string,
    ...
    const items = await this.service.findAll({
      ...
      autm_court_name: autm_court_name?.trim() || undefined,
      autm_specialty: autm_specialty?.trim() || undefined,
      autm_office_name: autm_office_name?.trim() || undefined,
      autm_year: autm_year?.trim() || undefined,
      autm_process_class: autm_process_class?.trim() || undefined,
      autm_process_code: autm_process_code?.trim() || undefined,
  ...
  async update(@Param('id') id: string, @Body() body: UpdateAutomationEmailDto) {
    ...
    const toUpdate: AutomationEmail = {
      ...
      autm_departament: body.autm_departament ? body.autm_departament.toUpperCase() : null,
      autm_city: body.autm_city ? body.autm_city.toUpperCase() : null,
      autm_locality: body.autm_locality ? body.autm_locality.toUpperCase() : null,
      autm_court_name: body.autm_court_name ? body.autm_court_name.toUpperCase() : null,
      autm_specialty: body.autm_specialty ? body.autm_specialty.toUpperCase() : null,
      autm_office_name: body.autm_office_name ? body.autm_office_name.toUpperCase() : null,
      autm_year: body.autm_year ?? null,
      autm_process_class: body.autm_process_class ? body.autm_process_class.toUpperCase() : null,
      autm_process_code: body.autm_process_code ? (body.autm_process_code.replace(/\D/g, '') || null) : null,
      autm_resource_process: body.autm_resource_process ?? null,
      autm_subject_demanding: body.autm_subject_demanding ? body.autm_subject_demanding.toUpperCase() : null,
      autm_artificial_person: body.autm_artificial_person ? body.autm_artificial_person.toUpperCase() : null,
      autm_document_type_1: body.autm_document_type_1 ? body.autm_document_type_1.toUpperCase() : null,
      ...
      autm_subject_defendant: body.autm_subject_defendant ? body.autm_subject_defendant.toUpperCase() : null,
      autm_natural_person: body.autm_natural_person ? body.autm_natural_person.toUpperCase() : null,
      autm_document_type_2: body.autm_document_type_2 ? body.autm_document_type_2.toUpperCase() : null,
  ...
  private toRow(item: AutomationEmail): Record<string, unknown> {
    const o: Record<string, unknown> = {
      ...
      autm_court_name: item.autm_court_name,
      autm_specialty: item.autm_specialty,
      autm_office_name: item.autm_office_name,
      autm_year: item.autm_year,
      autm_process_class: item.autm_process_class,
      autm_process_code: item.autm_process_code,
      autm_resource_process: item.autm_resource_process,

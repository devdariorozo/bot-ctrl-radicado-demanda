...
export class TblAutomationEmailMigration1771978729016 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    if (isPostgres(queryRunner)) {
      await queryRunner.query(`DROP TABLE IF EXISTS tbl_automation_email CASCADE`);
      await queryRunner.query(`
        CREATE TABLE tbl_automation_email (
          autm_id                SERIAL        PRIMARY KEY,
          ...
          autm_court_name        VARCHAR(255)  NULL,
          autm_specialty         VARCHAR(100)  NULL,
          autm_office_name       VARCHAR(100)  NULL,
          autm_year              VARCHAR(10)   NULL,
          autm_process_class     VARCHAR(100)  NULL,
          autm_process_code      VARCHAR(50)   NULL,
          autm_resource_process  VARCHAR(50)   NULL,
          ...
          autm_created_at        TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP,
          autm_updated_at        TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP,

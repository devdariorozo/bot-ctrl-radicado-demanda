...
export class TblManagementCtrlFiledDemandMigration1771978729017 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    if (isPostgres(queryRunner)) {
      await queryRunner.query(`DROP TABLE IF EXISTS tbl_management_ctrl_filed_demand CASCADE`);
      await queryRunner.query(`
        CREATE TABLE tbl_management_ctrl_filed_demand (
          mcfd_id                  SERIAL        PRIMARY KEY,
          ...
          mcfd_data_courts         INT           NULL,
          mcfd_automation_email_id INT           NULL,
          mcfd_last_execution      TIMESTAMP     NULL,
          ...
          mcfd_created_at          TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP,
          mcfd_updated_at          TIMESTAMP     NOT NULL DEFAULT CURRENT_TIMESTAMP,
